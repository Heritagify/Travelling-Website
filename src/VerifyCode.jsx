    ...
    <div className="block md:flex bg-gray-200 min-h-full">
      <div className="md:w-1/2 md:p-14">
        ...
        >
          ...
          <h1 className="text-4xl my-2 tracking-wide font-semibold font-monts">
            Verify Code
          </h1>
          <p className="w-96 text-xs font-monts py-2 font-medium">
          ...
          <button
            type="submit"
            className="w-full py-2 rounded-md font-semibold hover:text-white bg-gradient-to-r from-blue-300 to-green-400"
          >
            Verify
          </button>
        </form>
