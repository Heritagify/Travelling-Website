...
const Home = () => {
  return (
    <div>
      {/* Hero Section */}
      <div className="rounded-3xl relative p-3 pt-1 bg-cover h-[550px] bg-center bg-gray-900 mx-3 mt-3" style={{ backgroundImage: 'url("/src/assets/lp1.png")' }}>
  ...
  <div className='md:mt-72 pt-72 md:pt-8 text-center'>
    ...
    <div className='mx-auto'>
      <button
        ...
        {/* Hotels Section */}
        <div className="rounded-3xl size-40 relative p-3 pt-1 md:w-full md:max-w-[31rem] h-[29rem] bg-cover bg-center" style={{ backgroundImage: 'url("/src/assets/hotels.png")' }}>
