    ...
    <div>
      ...
      >
        ...
        <div className="relative text-white text-center mt-32 tracking-wide leading-loose">
          ...
          <h1 className="font-bold font-trade-gothic text-7xl my-2">
            LIVE & TRAVEL
          </h1>
        ...
        <div className="relative rounded-lg px-1 pt-2 pb-2 mx-5 mt-32 shadow-md shadow-blue-400 bg-white">
          <div className="flex text-blackGreen">
            ...
            <button className="flex py-2 px-4 border-l-2 ">
      ...
      <div className="mx-5 md:mx-28">
        <div className="md:flex justify-between mt-52">
          ...
          <button className="border-4 rounded-2xl hover:bg-cyan-300 lg:border-2 px-3 mx-20 py-2 lg-mx-0 mt-2 lg:mt-0 text-gray-700 lg:text-md">
            See more places
          </button>
        </div>
        <Places />
      ...
      <div className="md:flex md:space-x-4 space-y-5 md:space-y-0 md:justify-center my-14">
        {/* Flights Section */}
        <div
          className="sm:px-10 rounded-3xl bg-cover md:w-full md:max-w-[31rem] h-[29rem] bg-center bg-gray-900"
          style={{ backgroundImage: 'url("/public-assets/flights.png")' }}
        >
          <div className="md:mt-72 pt-72 md:pt-8 text-center">
            <h1 className="text-white text-5xl sm:text-4xl tracking-wide font-bold font-montserrat">
              Flights
            </h1>
            <p className="text-white text-center font-normal text-sm leading-5 my-2">
              Search Flights & Places. Hire to our most popular destinations.
            </p>
        ...
        {/* Hotels Section */}
        <div
          className="rounded-3xl size-40 relative p-3 pt-1 md:w-full md:max-w-[31rem] h-[29rem] bg-cover bg-center"
          style={{ backgroundImage: 'url("/public-assets/hotels.png")' }}
        >
          <div className="mt-72 pt-3 text-center">
            <h1 className="text-white text-4xl tracking-wide font-bold font-montserrat">
              Hotels
            </h1>
            <p className="text-white text-center font-normal text-sm leading-5 my-2">
