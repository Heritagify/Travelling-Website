...
//       password
  ...
  return (
    <div className='flex flex-row h-screen md:justify-center items-center '>
      <form
        onSubmit={handleSubmit}
        className='md:border-t-4 md:shadow-md shadow-cyan-800 rounded-lg p-3 space-y-4 md:space-y-2 w-full md:w-1/3 lg:w-2/5'
      >
        <h1 className='font-semibold text-4xl md:text-2xl text-center'>Sign Up</h1>

          <fieldset className='border border-gray-600 md:border-gray-400 rounded-md'>
            <legend className='mx-3 md:mx-1 text-xl md:text-xs font-medium'>First name</legend>
            <input type="text" name="firstName"
              placeholder='John'
              className='block outline-none w-full p-1 placeholder:text-sm'
              onChange={(e) =>setFirstName(e.target.value)}
            />
          </fieldset>
          <fieldset className='border border-gray-600 md:border-gray-400 rounded-md'>
            <legend className='mx-3 md:mx-1 text-xl md:text-xs font-medium'>Last name</legend>
          ...
          <fieldset className='border border-gray-600 md:border-gray-400 rounded-md'>
            <legend className='mx-3 md:mx-1 text-xl md:text-xs font-medium'>Email</legend>
            <input type="email" name="email"
              placeholder='herogreatness@gmail.com'
              className='block outline-none w-full p-1 placeholder:text-sm'
              onChange={(e) =>setEmail(e.target.value)}
            />
          </fieldset>
          <fieldset className='border border-gray-600 md:border-gray-400 rounded-md'>
            <legend className='mx-3 md:mx-1 text-xl md:text-xs font-medium'>Phone Number</legend>
          ...
          <fieldset className='border border-gray-600 md:border-gray-400 rounded-md'>
            <legend className='mx-3 md:mx-1 text-xl md:text-xs font-medium'>Password</legend>
            <input
              type="password"
              placeholder='**********'
              className='block outline-none w-full p-1'
        ...
        <button
          type="submit"
          className='bg-green-800 w-full p-3 md:p-1 text-xl text-white rounded-lg hover:bg-green-600 hover:font-semibold'>Sign Up</button>
          <p className='text-lg md:text-sm font-semibold'>Have an Account?
            <Link to="/login" className='text-red-500 mx-1 italic text-xl md:text-sm font-semibold'>Login</Link>
          </p>
      </form>
    </div>
  )
