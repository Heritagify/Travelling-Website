              ...
              <div className="relative">
                ...
                {isUserOptionsOpen && (
                  <div className="absolute right-0 sm:right-5 lg:right-0 top-full mt-2 w-52 md:w-64 lg:w-48 bg-mintGreen shadow shadow-green-700 rounded-lg">
                    ...
                    <Link to="/account/paymentMethod" className="flex items-center gap-1 py-2 px-3 text-sm md:text-lg lg:text-xs font-medium md:font-semibold lg:font-medium font-monts hover:bg-blackGreen hover:text-mintGreen hover:px-9"><MdPayments className='md:text-xl lg:text-sm'/>Payments</Link>
