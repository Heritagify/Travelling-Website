    ...
    <div className="block md:flex bg-gray-200 min-h-full">
      <div className="md:w-1/2 md:p-14">
        ...
        <div className="pt-12 mx-3 md:mx-8 text-blackGreen">
          ...
          <h1 className="text-4xl my-2 tracking-wide font-semibold font-monts">Set a password</h1>
          <p className="w-96 text-xs font-monts py-2 font-medium">Your previous password has been reset. Please set a new password for your account.</p>
          ...
          <fieldset className="flex justify-between items-center border-2 border-green-300 py-1 w-full mt-4 my-5 rounded-md">
            ...
            />
            {showPassword1 ? (
              <FaEyeSlash className="mx-3 cursor-pointer" onClick={togglePasswordVisibility1} />
            ) : (
              <FaEye className="mx-3 cursor-pointer" onClick={togglePasswordVisibility1} />
            )}
          </fieldset>
          ...
          <fieldset className="flex justify-between items-center border-2 border-green-300 py-1 w-full mt-4 my-5 rounded-md">
            ...
            />
            {showPassword2 ? (
              <FaEyeSlash className="mx-3 cursor-pointer" onClick={togglePasswordVisibility2} />
            ) : (
              <FaEye className="mx-3 cursor-pointer" onClick={togglePasswordVisibility2} />
            )}
          </fieldset>
